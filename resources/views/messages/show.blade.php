            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="mb-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="flex items-center mt-2">
                        <img src="{{ asset('storage/car_images/'.$conversation->car->primaryImage->image_path )}}" alt="{{ $conversation->car->title }}" class="w-16 h-16 object-cover rounded">
                        <div class="ml-4">
                ...
                <div class="space-y-4 mb-6">
                    @foreach($messages as $message)
                        <div class="flex {{ $message->user_id === Auth::id() ? 'justify-end' : 'justify-start' }}">
                            <div class="max-w-lg {{ $message->user_id === Auth::id() ? 'bg-blue-100' : 'bg-gray-100' }} rounded-lg p-4">
